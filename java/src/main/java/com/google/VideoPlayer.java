...
public class VideoPlayer {
  ...
  //function to retreive video id , tag and title
  ...
  // Function implemented to showAllVideos()
  ...
  // Function implemented to stop the current playing video
  ...
  // Function implemented to play a new video.
  ...
  // Function implemented to play random video using random function();
